...
class Futbolista(Persona,Deportista):
    ...
    def __str__(self):
        return f"Mi nombre es {Persona.getNombre} soy profesinal en el deporte {Deportista.getDeporte} Tengo {Persona.getEdad} años de edad y llevo {self.getAñosParticipando()} años en el deporte"
